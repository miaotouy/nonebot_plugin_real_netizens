...
class CharacterManager:
    ...
    def __init__(self, group_config_manager):  # 添加 group_config_manager 参数
        ...
        self.group_config_manager.register_observer(
            self.on_config_change)  # 注册为观察者
    ...
    async def load_character(self, character_id: str):
        ...
        try:
            ...
            # 更新世界书
            for worldbook_name, resource in worldbook_updates:
                self.worldbooks[worldbook_name] = resource  # 直接更新字典
    ...
    def get_character_info(
        ...
        """
        # 从群组配置中获取角色 ID
        character_id = self.group_config_manager.get_group_config(
            group_id).character_id  # 使用self.group_config_manager
